...
<body>
    ...
    <script>
        ...
        function objectToJesusMaria() {
            let horario = '<h3>Nuestro Delivery Web atiende de Martes a Domingo de 5:30 pm a 10:40 pm</h3>';

            return horario;
        }

        function objectToLocales() {
            let horario = '<h3>Nuestro Delivery Web atiende de Lunes a Sábado de 12:30 pm a 9:00 pm</h3>';
