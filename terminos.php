...
<div class="container main-container animated fadeIn slow mb-5">
    ...
    <div class="row mb-5">
        <div class="col text-center">
            ...
            <p>
                Por cada 100 puntos de consumo ganas 10 soles.
            </p>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col text-center">
            <h2>¿Los puntos pueden expirar?</h2>
            <p>
                Válido para ser canjeado como máximo en 60 días.
            </p>
        </div>
    </div>
    <div class="row my-4">
        <div class="col">
            ...
            <p>El presente Política de Privacidad establece los términos en que El Egipcio usa y protege la información
                ...
                esta página para asegurarse que está de acuerdo con dichos cambios.</p>
            ...
            <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su
                ...
                dan acceso a información de su ordenador ni de usted, a menos de que usted así lo quiera.
                ...
                configuración de su ordenador para declinar las cookies. Si se declinan es posible que no pueda utilizar
            ...
            <p>Este sitio web pudiera contener en laces a otros sitios que pudieran ser de su interés. Una vez que usted
                ...
                por lo cual es recomendable que los consulte para confirmar que usted está de acuerdo con estas.</p>
