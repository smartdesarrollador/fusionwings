...
try {
    ...
    if ($_SESSION['envio'] == 'recojo' || $_SESSION['solo_gift_cards'] == 'true') {
        ...
        $pedidoInsertado = $objPedido->addPedido($customerID,
            '-', $telefono, $observaciones, $totalPipe, $puntosGanados,
            $lastFour, $card_number, $horaPedido, $brand, $saldoBilletera, 'false',
            '-', $_SESSION['current_customer_tipoDocumento'], $razonSocial, $direccionFiscal, $ruc, $latitud, $longitud, 0, $idTienda);
    } else {

        $pedidoInsertado = $objPedido->addPedido($customerID,
            $direccion, $telefono, $observaciones, $totalPipe, $puntosGanados,
            $lastFour, $card_number, $horaPedido, $brand, $saldoBilletera, 'true',
            $distrito, $_SESSION['current_customer_tipoDocumento'], $razonSocial, $direccionFiscal, $ruc, $latitud, $longitud, $costoEnvio, $idTienda);
