...
/* $monto_total_izi = $_SESSION['monto_total'];

echo $monto_total_izi;
...
try {
    ...
    */
    ...
    //$totalPipe = $_SESSION['monto_total'] / 100;

    //$totalPipe = $_SESSION['monto_real'];

    if ($_SESSION['estado_descuento'] == 'true') {
        $totalPipe = $_SESSION['monto_real'];
        $precio_con_descuento = $_SESSION['monto_con_descuento'] / 100;
        $codigo_cupon = $_SESSION['codigo_cupon'];
        $estado_descuento = $_SESSION['estado_descuento'];
    } else {
        $totalPipe = $_SESSION['monto_real'] / 100;
        $precio_con_descuento = $_SESSION['monto_con_descuento'];
        $codigo_cupon = $_SESSION['codigo_cupon'];
        $estado_descuento = $_SESSION['estado_descuento'];
    }

    /* $prueba_descuento = "total_real:" . $totalPipe . " -  precio con descuento: " . $precio_con_descuento . " -  codigo_cupon: " .  $codigo_cupon . " -  estado_descuento: " .  $estado_descuento;

    echo $prueba_descuento;
