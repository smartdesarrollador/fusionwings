                                    ...
                                    <ul class="docs-pictures list-unstyled">
                                        <li>
                                            <img style="cursor: zoom-in"
                                                    data-original="assets/img/qrCodes/<?php echo $clienteActual['qrCode'] ?>"
                                                    class="w-50"
                                                    src="assets/img/qrCodes/<?php echo $clienteActual['qrCode'] ?>"
                                                    alt="">
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="row animated fadeIn slow" id="botonesActualizar">
                                        <div class="col-12 text-right">
                                            <a onclick="window.location.reload()" class="btn btn-secondary btn-lg">Cancelar</a>
