...
if ($_SESSION['estado_cupon']) {
    ...
    if ($_SESSION['estado_cupon'] == "activo" && $cartTotal >= $tienda['cantidadTotal'] && $deliveryZone['idTienda'] == 1) {
    ...
    <div class="container mb-5">
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="row mt-4">
                    <?php if ($deliveryZone['idTienda'] == 1) { ?>
                        <div class="col">
                    ...
                    <?php if ($_SESSION['estado_cupon'] == "activo" && $cartTotal >= $tienda['cantidadTotal'] && $deliveryZone['idTienda'] == 1) { ?>
                        <div class="col">
                            <a href="#" id="codigodecupon" class="btn btn-outline-secondary"><?php echo $codigo_cupon; ?></a>
                            <h5 class="text-success">Cupon Valido</h5>
                        </div>
                    <?php } elseif ($_SESSION['estado_cupon'] == "activo" && $cartTotal < $tienda['cantidadTotal'] && $deliveryZone['idTienda'] == 1) { ?>
                        <div class="col">
                            <a href="#" id="codigodecupon" class="btn btn-outline-secondary"><?php echo $codigo_cupon; ?></a>
                    ...
                    <?php } elseif ($_SESSION['estado_cupon'] == "inactivo" && $deliveryZone['idTienda'] == 1) { ?>
                        <div class="col">
                            <a href="#" id="codigodecupon" class="btn btn-outline-secondary">Ingresa tu Código de Cupón</a>
                            <h5 class="text-danger">Cupon no Valido</h5>
                        </div>
                    <?php } elseif (!isset($_SESSION['estado_cupon']) && $deliveryZone['idTienda'] == 1) {  ?>
                        <div class="col">
                            <a href="#" id="codigodecupon" class="btn btn-outline-secondary">Ingresa tu Código de Cupón</a>
                        </div>
                    <?php }   ?>
