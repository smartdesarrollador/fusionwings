...
class Delivery
{
    ...
    public function getDeliveryZoneById($id)
    {
        try {
            $sql = "
...
where delivery.id = '$id'
    ...
    public function addNewDeliveryZone($name, $coords, $price, $idTienda)
    {
        date_default_timezone_set('America/Lima');
        $actualDate = time();
        $sql = "INSERT INTO delivery(name,coords,price,idTienda)
