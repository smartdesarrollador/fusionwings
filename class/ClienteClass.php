...
class ClienteClass
{
    ...
    public function updateCustomerDetails($dni, $direccion, $telefono, $idCliente, $fechaNacimiento, $apellido = '',$distrito)
    {

        $sql = "UPDATE clientes SET DNI = '$dni', direccion ='$direccion',celular='$telefono',fechaNacimiento = '$fechaNacimiento',apellido = '$apellido',distrito = '$distrito'
                WHERE idCliente =  '$idCliente'  ";

        $affectedRows = AccesoBD::OtroSQL($this->cn, $sql);
        return $affectedRows;
    }
    public function updateCustomerDetailsWithLatLng($dni, $direccion, $telefono, $idCliente, $fechaNacimiento, $apellido = '',$lat,$long,$distrito)
    {

        $sql = "UPDATE clientes SET DNI = '$dni', direccion ='$direccion'
            ,celular='$telefono'
